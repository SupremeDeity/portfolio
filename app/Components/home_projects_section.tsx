...
export function HomeProjectsSection() {
  return (
    <div className="shadow shadow-emerald-400 snap-start ">
        ...
        <div className="self-center text-white grid sm:grid-cols-2 sm:gap-x-16 gap-y-16 mb-16 mx-8">
          <div>
            ...
            <div className="flex items-center justify-between">
              ...
              <a href="https://github.com/supremedeity/urbane" target="_blank">
          ...
          <div>
            ...
            <div className="flex items-center justify-between">
              ...
              <a href="https://github.com/supremedeity/maestro" target="_blank">
                <FaGithub className="hover:fill-gray-300 text-lg transition-colors duration-100 ease-in" />
              </a>
            </div>
            <span className="text-sm text-primary font-semibold">
